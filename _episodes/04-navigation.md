...
>
> * You can go back to (and edit) the previous commands you typed with <kbd>&uarr;</kbd>. If you go too far in history, you can move forward in history with <kbd>&darr;</kbd>. Using these keys well will avoid a lot of type, in particular if you introduce typos, or want to make small adjustments to a command!
